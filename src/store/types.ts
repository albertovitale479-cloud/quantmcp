...
export interface ResearchProgress { operation: string; stage: string; completed: number; total: number }
export interface WorkspaceState {
  ...
  researchUniverse: string[]; universeStudy: UniverseStudy | null; parameterSearch: ParameterSearchResult | null; universalParameterSearch: UniversalParameterSearchResult | null
  historicalTrades: HistoricalTrade[]; selectedTradeId: string | null; tradeStudyStatistics: TradeStudyStatistics | null
  quantitativeMetrics: QuantMetric[]; loading: boolean; progress: ResearchProgress | null; error: string | null
}
export interface WorkspaceActions {
  ...
  setResearchUniverse: (assets: string[]) => void; setUniverseStudy: (study: UniverseStudy | null) => void; setParameterSearch: (result: ParameterSearchResult | null) => void; setUniversalParameterSearch: (result: UniversalParameterSearchResult | null) => void
  ...
  setLoading: (loading: boolean) => void; setProgress: (progress: ResearchProgress | null) => void; setError: (error: string | null) => void
}
